...
Runs gradual ramp-up load test (10-50 VUs) with sustained load
"""
...
def main():
    ...
    # Set default values
    k6_base_url = os.environ.get('K6_BASE_URL', 'http://backend-dev:8000')
    k6_frontend_url = os.environ.get('K6_FRONTEND_URL', 'http://frontend-dev:3000')
    ...
    influxdb_url = os.environ.get('INFLUXDB_URL', 'http://influxdb-k6:8086')
    ...
    if use_service_names:
        ...
        # WARNING: Requires backend-dev, frontend-dev, influxdb-k6 in Django ALLOWED_HOSTS
