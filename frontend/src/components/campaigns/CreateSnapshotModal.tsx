...
import { MilestoneType, MetricType, CreateSnapshotData } from '@/types/campaign';
...
export default function CreateSnapshotModal({
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await CampaignAPI.createSnapshot(campaignId, data);
  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>New Performance Snapshot</DialogTitle>
          <DialogDescription>
            Document campaign performance at a key milestone. Spend and primary metric are required.
          </DialogDescription>
        </DialogHeader>
        ...
        <DialogFooter>
          ...
          <Button
            ...
            disabled={submitting || !milestoneType || !spend || !metricType || !metricValue}
            loading={submitting}
          >
            Create Snapshot
          </Button>
