...
type UnifiedNotificationsSectionProps = {
  onRedirectToLogin: () => void;
};

export default function UnifiedNotificationsSection({ onRedirectToLogin }: UnifiedNotificationsSectionProps) {
  return (
    <>
                    ...
                    <div className="flex items-center">
                      <div className="w-4 h-4 flex items-center justify-center">
                        <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
                          ...
                          <path d="M8.578 12.645a2.527 2.527 0 0 0 2.52-2.52 2.527 2.527 0 0 0-2.52-2.522 2.527 2.527 0 0 0-2.523 2.522 2.527 2.527 0 0 0 2.523 2.52m6.304 0a2.528 2.528 0 0 0 2.521-2.52 2.527 2.527 0 0 0-2.521-2.522 2.527 2.527 0 0 0-2.52 2.522 2.527 2.527 0 0 0 2.52 2.52m6.313-2.52a2.528 2.528 0 0 0-2.523-2.523 2.528 2.528 0 0 0-2.52 2.523 2.528 2.528 0 0 0 2.52 2.521 2.528 2.528 0 0 0 2.523-2.521m-6.313 2.52a2.528 2.528 0 0 0 2.522 2.523 2.528 2.528 0 0 0 2.521-2.523 2.528 2.528 0 0 0-2.521-2.521 2.528 2.528 0 0 0-2.522 2.521" fill="#36C5F0"/>
