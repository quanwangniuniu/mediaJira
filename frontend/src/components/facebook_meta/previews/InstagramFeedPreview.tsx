...
const InstagramFeedPreviewContent: React.FC<InstagramFeedPreviewProps> = ({
  mediaToShow,
  primaryText,
}) => {
    ...
    <>
      <div className="h-[613px] w-[307px] mt-4 relative bg-gray-200 rounded-sm group flex-1 overflow-hidden flex flex-col justify-center">
        <div className="bg-white rounded-sm shadow-md">
          ...
          <div className="flex justify-between items-center border-t border-gray-200 px-2 py-2 mt-2">
          ...
          {primaryText && <div className="px-2">
  ...
  return (
    ...
    >
      <PreviewHeader
        ...
        onReportProblem={() => console.log('Report Instagram Feed problem')}
      />
      <InstagramFeedPreviewContent mediaToShow={mediaToShow} primaryText={primaryText} />
      <PreviewExpandModal
        isOpen={isModalOpen}
