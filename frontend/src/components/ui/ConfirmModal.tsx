    ...
    switch (type) {
      ...
      case 'warning':
        return {
          ...
          confirmButton: 'bg-yellow-600 hover:bg-yellow-700 focus:ring-yellow-500 border-yellow-600',
        };
      case 'info':
        return {
          icon: (
        ...
        <div className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
          ...
          <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
            <button
              ...
              disabled={loading}
              className={`inline-flex w-full justify-center rounded-md border px-3 py-2 text-sm font-semibold text-white shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 sm:ml-3 sm:w-auto disabled:opacity-50 disabled:cursor-not-allowed transition-colors ${typeStyles.confirmButton}`}
            >
              {loading ? (
