...
import { MeetingActionItemsSection } from '@/components/meetings/MeetingActionItemsSectionFixed';
  ...
  const renderBody = () => {
    ...
    return (
      <div className="grid gap-6">
        ...
        <MeetingActionItemsSection projectId={projectId} meetingId={meetingId} />
