...
export interface TaskData {
  ...
  type: "budget" | "asset" | "retrospective" | "report" | "scaling" | "experiment" | "communication"; // Valid task types
  summary: string;
  description?: string;
...
export interface CreateTaskData {
  project_id: number;
  type: "budget" | "asset" | "retrospective" | "report" | "scaling" | "experiment" | "communication";
  summary: string;
  description?: string;
