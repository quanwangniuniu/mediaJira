...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'sidebar.meetings_description': 'Meeting preparation and project meetings',
    'sidebar.tasks': 'Tasks',
    'sidebar.notion': 'Notion',
    'sidebar.notion_editor': 'Draft documents with Notion-like editor',
    'sidebar.facebook_meta': 'Facebook Meta',
    ...
    'sidebar.facebook_meta_ad_creative_management': 'Facebook meta Ad Creative management',
    'sidebar.tiktok_management': 'TikTok content management',
  ...
  zh: {
    ...
    'sidebar.meetings': '会议',
    'sidebar.meetings_description': '会议准备与各项目会议',
    'sidebar.tasks': '任务',
    'sidebar.notion': 'Notion',
    'sidebar.notion_editor': '使用 Notion 风格编辑器起草文档',
    'sidebar.facebook_meta': 'Facebook 元数据',
    'sidebar.tiktok': 'TikTok',
    'sidebar.reports': '报告',
    'sidebar.messages': '消息',
    'sidebar.calendar': '日历',
    ...
    'sidebar.facebook_meta_ad_creative_management': 'Facebook 元数据广告创意管理',
    'sidebar.tiktok_management': 'TikTok 内容管理',
