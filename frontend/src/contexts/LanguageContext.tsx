...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'sidebar.mailchimp_email_drafts_management': 'Mailchimp email drafts management',
  ...
  zh: {
    ...
    'sidebar.mailchimp_email_drafts_management': 'Mailchimp 邮件草稿管理',
