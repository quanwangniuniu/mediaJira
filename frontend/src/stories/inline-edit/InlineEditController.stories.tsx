...
function KeyboardEnterToSaveStory() {
...
export const KeyboardEnterToSave = { render: () => <KeyboardEnterToSaveStory /> };

function KeyboardEscToCancelStory() {
...
export const KeyboardEscToCancel = { render: () => <KeyboardEscToCancelStory /> };

function BlurToSaveEnabledStory() {
...
export const BlurToSaveEnabled = { render: () => <BlurToSaveEnabledStory /> };

function BlurToSaveDisabledStory() {
...
export const BlurToSaveDisabled = { render: () => <BlurToSaveDisabledStory /> };

function CompleteKeyboardSupportStory() {
...
export const CompleteKeyboardSupport = { render: () => <CompleteKeyboardSupportStory /> };
...
export const WithValidation = { render: () => <WithValidationStory /> };

function WithAsyncValidationStory() {
  const [savedValue, setSavedValue] = useState('');
...
export const WithAsyncValidation = { render: () => <WithAsyncValidationStory /> };

function ErrorHandlingStory() {
...
export const ErrorHandling = { render: () => <ErrorHandlingStory /> };

function CustomRenderTriggerStory() {
...
export const CustomRenderTrigger = { render: () => <CustomRenderTriggerStory /> };

function SynchronousSaveStory() {
...
export const SynchronousSave = { render: () => <SynchronousSaveStory /> };

function AsynchronousSaveStory() {
...
export const AsynchronousSave = { render: () => <AsynchronousSaveStory /> };
