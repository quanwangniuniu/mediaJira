  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <InlineEditDemo
          initialValue={savedValue}
          onSave={(newValue) => setSavedValue(newValue)}
        />
      </div>
      <div className="mt-4 p-4 bg-gray-50 rounded">
        <p className="text-sm text-gray-600">
...
export const TextareaInput = { render: () => <TextareaInputStory /> };

function DisableBlurToSaveStory() {
...
export const DisableBlurToSave = { render: () => <DisableBlurToSaveStory /> };
...
export const StateDisplay = { render: () => <StateDisplayStory /> };
