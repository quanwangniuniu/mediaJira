...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'Testimonials section with desktop and mobile layouts.',
      },
    },
  },
  tags: ['autodocs'],
        ...
        <section className="block md:hidden py-10 px-6 bg-white">
          <div className="max-w-4xl mx-auto">
            <div className="bg-blue-50 rounded-2xl p-8 mb-6">
              ...
              <div className="text-center">
                <button onClick={handleGetStartedClick} className="flex items-center px-6 py-3 bg-blue-800 text-white rounded-full hover:bg-blue-900 transition text-center font-medium text-sm gap-4 shadow-lg">
                  Get Started
