    ...
    args: {
      ...
      children: (
        <div className="flex" style={{ width: '800px' }}>
          <div className="bg-green-100 border border-green-300 rounded p-4 mr-2 flex-shrink-0" style={{ width: '150px' }}>
            Item 1
          </div>
          <div className="bg-green-100 border border-green-300 rounded p-4 mr-2 flex-shrink-0" style={{ width: '150px' }}>
            Item 2
    ...
    args: {
      ...
      children: (
        <div className="flex" style={{ width: '600px' }}>
          <div className="bg-orange-100 border border-orange-300 rounded p-4 mr-2 flex-shrink-0" style={{ width: '120px' }}>
            Card 1
          </div>
          <div className="bg-orange-100 border border-orange-300 rounded p-4 mr-2 flex-shrink-0" style={{ width: '120px' }}>
            Card 2
