...
export const baseGoogleAds: GoogleAd[] = [
  {
    ...
    status: "DRAFT",
    final_urls: ["https://marketingsimplified.com/search"],
    created_at: "2026-02-01T10:20:00Z",
    updated_at: "2026-02-02T08:10:00Z",
    responsive_search_ad: {
      headlines: [{ text: "Scale faster with Marketing Simplified" }, { text: "Smarter campaign ops" }, { text: "AI workflow for ads" }],
  ...
  },
  {
    ...
    status: "PUBLISHED",
    final_urls: ["https://marketingsimplified.com/display"],
  ...
  },
  {
    ...
    status: "PAUSED",
    final_urls: ["https://marketingsimplified.com/video"],
