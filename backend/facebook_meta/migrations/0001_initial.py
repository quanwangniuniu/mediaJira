...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='AdAccount',
            fields=[
                ('id', models.CharField(help_text='ID of the ad account.', max_length=64, primary_key=True, serialize=False, unique=True)),
                ('name', models.CharField(help_text='Name of the ad account.', max_length=255)),
                ('status', models.CharField(choices=[('ACTIVE', 'Active'), ('CLOSED', 'Closed')], help_text='Status of the ad account.', max_length=255)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='owned_ad_creatives', to='facebook_meta.adaccount')),
                ...
                ('object_story_spec_photo_data', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='photo_data_ad_creatives', to='facebook_meta.adcreativephotodata')),
                ...
                ('object_story_spec_video_data', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='video_data_ad_creatives', to='facebook_meta.adcreativevideodata')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='owned_ad_labels', to='facebook_meta.adaccount')),
            ],
        ),
        migrations.AddField(
