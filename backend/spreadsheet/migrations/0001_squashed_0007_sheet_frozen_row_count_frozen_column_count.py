...
class Migration(migrations.Migration):
    ...
    replaces = [('spreadsheet', '0001_initial'), ('spreadsheet', '0005_spreadsheetcellformat_font_family_font_size'), ('spreadsheet', '0006_spreadsheetcellformat_number_format'), ('spreadsheet', '0007_sheet_frozen_row_count_frozen_column_count')]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'constraints': [models.UniqueConstraint(fields=('sheet', 'row_index', 'column_index'), name='unique_sheet_cell_format_position')],
            },
        ),
        migrations.AddField(
            model_name='sheet',
