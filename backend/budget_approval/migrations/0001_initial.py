# Generated by Django 4.2.23 on 2025-08-04 14:59
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_amount', models.DecimalField(decimal_places=2, help_text='Total budget pool amount', max_digits=15)),
                ('used_amount', models.DecimalField(decimal_places=2, default=Decimal('0.00'), help_text='Amount of budget used from this pool', max_digits=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('amount', models.DecimalField(decimal_places=2, help_text='Requested budget amount', max_digits=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('threshold_amount', models.DecimalField(decimal_places=2, help_text='Escalation threshold amount', max_digits=15)),
