    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "start_date",
                    models.DateTimeField(help_text="When the campaign should start"),
                ),
                (
                    "end_date",
                    models.DateTimeField(help_text="When the campaign should end"),
                ),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                ...
                through="campaigns.CampaignAssignment",
                to=settings.AUTH_USER_MODEL,
            ),
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="campaigns_c_campaig_296e25_idx",
                    ),
                    models.Index(
                        fields=["recorded_at"], name="campaigns_c_recorde_ae95e8_idx"
                    ),
                ],
        ...
        migrations.AddIndex(
            model_name="campaign",
            index=models.Index(
                fields=["campaign_type"], name="campaigns_c_campaig_ff160b_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="campaign",
