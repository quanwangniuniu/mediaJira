...
NOTE: CampaignTask, ExecutionLog, ChannelConfig, and ROIAlertTrigger models
do not exist in campaign.models. These factories are commented out until
...
# These models do not exist in campaign.models yet
...
# CampaignTask model does not exist in campaign.models
...
# ExecutionLog model does not exist in campaign.models
...
# ChannelConfig model does not exist in campaign.models
...
# ROIAlertTrigger model does not exist in campaign.models
...
CampaignTaskFactory = None
ExecutionLogFactory = None
ChannelConfigFactory = None
ROIAlertTriggerFactory = None
