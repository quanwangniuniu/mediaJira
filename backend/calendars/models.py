...
class CalendarEvent(TimeStampedModel):
    """
    CalendarEvent 是系统从 Decision 和 Task 自动生成的只读投影。
    不允许用户手动创建或修改，只能查看和点击跳转到源实体。
    源实体删除时，对应的 CalendarEvent 也会级联删除。
    ...
    # ── 关联 Review（精确追踪 Review Event 来源）──────────
