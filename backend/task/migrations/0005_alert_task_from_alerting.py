# Generated by Cursor - Consolidate alerting into task app
...
def create_alert_task_table_if_not_exists(apps, schema_editor):
    """
    Create alert_task table for fresh DBs (e.g. CI, new deployments).
    For existing DBs the table may already exist from alerting migrations.
    """
    from django.db import connection

    with connection.cursor() as cursor:
        tables = connection.introspection.get_table_list(cursor)
        if any(t.name == "alert_task" for t in tables):
            return
    AlertTask = apps.get_model("task", "AlertTask")
    schema_editor.create_model(AlertTask)
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunPython(create_alert_task_table_if_not_exists, migrations.RunPython.noop),
    ]
