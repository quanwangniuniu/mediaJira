---
name: create-pr
description: Prepare a well-structured pull request with Conventional Commits, Jira key support, clear description, and pre-merge checks. Use when changes are ready for review.
---
...
- User asks to create a PR, open a pull request, or prepare for merge.
- User mentions submitting changes for review or linking a Jira ticket to a PR.
- Task involves finalizing a branch for code review.

## Context

- Follow **.cursor/AGENTS.md** (Git / PR section) and **.cursor/rules.md**. See README and CICD_README.md for CI/CD and testing details.
- Use any user-provided context (Jira key, scope, branch name) in the PR title or description.
