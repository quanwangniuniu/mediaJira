---
name: security-audit
description: Perform a security pass aligned with MediaJira standards (no secrets, auth/CORS, input validation, least privilege, credential handling). Use for pre-release checks or when touching auth/sensitive code.
---
...
- User asks for a security review, security audit, or security pass.
- User mentions auth, credentials, CORS, or sensitive data handling.
- Task involves pre-release checks or changes to authentication or authorization.
